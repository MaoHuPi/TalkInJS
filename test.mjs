import {the, Something, Ordinal, State, Pronoun, Timeline, StateValuePair} from './talkin.mjs';
...
//     static #subset = [];
//     constructor(info = {}){super();}
//     static contain(something){Cat.#subset.push(something);}
//     static _contain(something){return Cat.#subset.includes(something);}
// }
// let the_cat = the(Cat);
